...
@Composable
internal fun HudRecentMessages(state: HudMessageState?, kinds: Set<HudMessageKind> = HudMessageKind.entries.toSet()) {
    ...
    messages.takeLast(5).asReversed().forEach { message ->
