...
class LegacyModelCategoryGuiTest {
    ...
    @Test fun previewIsOptionalAndApplyPreservesOtherModelSelections() {
        val parsed = LegacySettingsReader.read("""(panel p
            ...
            (item drag :target showDrag :type switch :value false))""")
