...
object LegacySettingsReader {
    ...
    fun read(text: String): LegacySettings {
        ...
        return LegacySettings(interval, flag("crosshairSwitch"), flag("enableVoiceWarn"), volume, choices,
            ...
            require(it.hasChanges || it.modelSectionChoices.isNotEmpty() || it.engineControlStyle != null || it.powerTextSizes != null || it.enginePanelFonts.isNotEmpty() || it.enginePanelPositions.isNotEmpty() || it.enginePanelVisibility.isNotEmpty() || it.engineReadingColumns != null || it.attitudeSize != null || it.hudRegionBorders.isNotEmpty() || it.flightTextSizes != null || it.flightLabelFont != null || it.flightReadingColumns != null || it.hudPositions.isNotEmpty() || it.hudRegionVisibility.isNotEmpty() || it.unmigrated.isNotEmpty()) { "未找到可迁移的设置" }
        }.let { settings ->
