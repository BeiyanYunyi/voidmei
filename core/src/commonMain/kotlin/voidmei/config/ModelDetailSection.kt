...
enum class ModelDetailSection(val label: String) {
    ...
    PISTON("活塞功率与曲线"), JET("喷气推力与曲线"), RAW("原始字段"), INERTIA("转动惯量"), WEP_FUEL("加力燃料"), THERMAL_RECOVERY("耐热恢复"),
    CLEAN_PART("无襟翼器件"), FULL_PART("满襟翼器件"), FUSELAGE_PART("机身器件"), FIN_PART("Fin 器件"), STAB_PART("Stab 器件"), MAXIMUM_LIFT("升力过载估算"), LIFT_PARAMETERS("升力参数"), DRAG("阻力参数")
}
